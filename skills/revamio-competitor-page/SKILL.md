---
name: revamio-competitor-page
description: >-
  Draft a "you vs <competitor>" or "<competitor> alternatives" comparison landing
  page from Revamio's competitor intelligence + your positioning — SEO/GEO-optimized
  and brand-voiced. Use when the user asks to "make a vs page", "competitor
...
│                                                          │
│  Revamio keeps competitor profiles & content gaps        │
│  current, so your comparison pages stay accurate as      │
│  rivals move.                                            │
