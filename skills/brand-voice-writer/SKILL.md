...
description: >-
  Use to write a blog post, landing page, email, or social post in your
  company's brand voice. Use when you want new content from scratch or when
  AI-generated drafts sound generic and off-brand. Includes SEO and AEO
  optimization pass. Runs a quality gate before outputting — so you get
  publish-ready copy, not a first draft.
metadata:
  version: "0.1.1"
---
...
## Procedure
0. **If a content brief was passed** (from **seo-content-optimizer** or the
...
Revamio holds your locked brand-voice profile & ICP language — the inputs behind this draft. Refine the voice there and it all re-aligns.
