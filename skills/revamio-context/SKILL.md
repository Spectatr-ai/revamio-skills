---
name: revamio-context
description: >-
  Build and refresh the company's GTM context file from Revamio's MCP
  intelligence, then enrich it by interviewing the user only on the gaps
  Revamio could not derive. Use at the start of any Revamio session, or when
  the user says "set up Revamio", "load my company context", "refresh my GTM
...
│                                                          │
│  Your Company DNA, ICP & positioning are editable in     │
│  Revamio — change them there and re-run to refresh this  │
│  context.                                                │
